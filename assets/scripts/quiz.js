    ...
    if (players['nome'][1] != '')
        if (players['nome'][1] == players['nome'][0])
            if (players['points'][1] == players['points'][0])
                content.innerHTML += `<span calss="befplay">Você tirou a mesma porcentagem no seu último jogo</span><p>${5 * players['points'][1]}% de acerto</p>`
            else
                players['points'][1] > players['points'][0] ? content.innerHTML += `<span class="befplay">Você diminuiu seus acertos</span><p>${5 * players['points'][1]}% de acerto na última jogada</p>` : content.innerHTML += `<span id="befplay">Você aumentou seus acertos</span><p>${5 * players['points'][1]}% de acerto na última jogada</p>`
        else
            content.innerHTML += `<span class="befplay">Último jogador: ${players['nome'][1]}</span><p>${5 * players['points'][1]}% de acerto</p>`
