...
function endgame(){
    begin = 0
    players['nome'][1] == '' ? content.innerHTML = `<span id="name">${players['nome'][0]}</span>
    <p id="points">${5 * players['points'][0]}% de acerto</p>` : content.innerHTML = `<span id="name">${players['nome'][0]}</span><p id="points">${5 * players['points'][0]}% de acerto</p>
    <span id="befplay">Último jogador: ${players['nome'][1]}</span>
    <p${5 * players['points'][0]}% de acerto</p>`
...
function play(){
    ...
    if (name.length >= 3){
        if(players['nome'][0] != ''){
            players['nome'][1] = players['nome'][1]
            players['points'][1] = players['points'][1]
            players['nome'][0] = name
            players['points'][0] = 0
        } else 
            players['nome'][0] = name
